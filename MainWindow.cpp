...
//    QObject::connect( ui->imgPlaceholder2, SIGNAL(clicked()), this,  )
  }
...
//  std::cout << "size of image2D: " << image2D.width() << ", " << image2D.height() << std::endl << std::flush;
  QImage img2 = image2D.scaled(ui->imgPlaceholder2->size());
//  std::cout << "size of img2: " << img2.width() << ", " << img2.height() << std::endl << std::flush;

  ui->imgPlaceholder2->setPixmap(QPixmap::fromImage(img2));
